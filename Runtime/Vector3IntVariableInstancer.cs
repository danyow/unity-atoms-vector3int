...
namespace UnityAtoms.BaseAtoms
{
    ...
    public class Vector3IntVariableInstancer : AtomVariableInstancer<Vector3IntVariable, Vector3IntPair, Vector3Int,
        Vector3IntEvent, Vector3IntPairEvent, Vector3IntVector3IntFunction>
    { }
}